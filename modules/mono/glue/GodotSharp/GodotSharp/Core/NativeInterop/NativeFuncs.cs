...
namespace Godot.NativeInterop
{
    ...
    public static unsafe partial class NativeFuncs
    {
        ...
        public static partial int godotsharp_array_binary_search(scoped ref godot_array p_self, int p_index, int p_count, in godot_variant p_value);
        ...
        public static partial int godotsharp_array_index_of(scoped ref godot_array p_self, in godot_variant p_item, int p_index = 0);

        public static partial void godotsharp_array_insert(ref godot_array p_self, int p_index, in godot_variant p_item);

        public static partial int godotsharp_array_last_index_of(scoped ref godot_array p_self, in godot_variant p_item, int p_index);

        public static partial void godotsharp_array_make_read_only(scoped ref godot_array p_self);
        ...
        public static partial godot_bool godotsharp_array_recursive_equal(scoped ref godot_array p_self, in godot_array p_other);
        ...
        public static partial void godotsharp_array_to_string(scoped ref godot_array p_self, out godot_string r_str);
